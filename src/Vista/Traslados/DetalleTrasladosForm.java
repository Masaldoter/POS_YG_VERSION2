...
public final class DetalleTrasladosForm extends javax.swing.JFrame {
    ...
    public void ObtenerId(int Seleccion, int TipoDeVista) {
        ...
        if (TipoDeVista == 0) {
            if (Seleccion == 0) {
                ...
                Query = "select idtraslados, NoTraslado from traslados where idtraslados = (select max(idtraslados) from traslados where idtraslados < " + Id.getText() + ")";
            }
        } else if (TipoDeVista == 1) {
            if (Seleccion == 0) {
                Query = "select idtraslados, NoTraslado from traslados where idtraslados = (select min(idtraslados) from traslados where idtraslados > " + Id.getText() + ") AND FechaRealizada LIKE '%" + fecha + "%'";
            } else if (Seleccion == 1) {
    ...
    private void initComponents() {
        ...
        Fechaventa.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "FECHA"));

        HoraVenta.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        HoraVenta.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        HoraVenta.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "HORA"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetalleTrasladosForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetalleTrasladosForm().setVisible(true);
            }
        });
    }
