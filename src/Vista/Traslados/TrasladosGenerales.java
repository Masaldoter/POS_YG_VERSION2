 ...
 * @author Masaldoter
 */
public class TrasladosGenerales extends javax.swing.JInternalFrame {
    POS pos;
    public String Parametro1, Parametro2;
    public int FiltroBusqueda;
    public TrasladosGenerales() {
        initComponents();
    }
    
    public TrasladosGenerales(POS pos) {
        this.pos = pos;
        initComponents();
    ...
    public void ActualizarTablaEstado(int Filtro_Busqueda, String Parametro1, String Parametro2){
        ConsultasTraslados tablas = new ConsultasTraslados();
        Tabla.setDefaultRenderer(Object.class, new RenderTablas());
        LimpiarTabla(Tabla);
        DefaultTableModel modelo;
        modelo = (DefaultTableModel) Tabla.getModel();
        List<Traslados> ListarPr = tablas.ListarTrasladosPorEstado(Estado, Filtro_Busqueda, Parametro1, Parametro2);
        Object[] ob = new Object[11];
        for (int i = 0; i < ListarPr.size(); i++) {
            ob[0] = ListarPr.get(i).getIdTraslado();
            ob[1] = ListarPr.get(i).getNoTraslado();
            ob[2] = ListarPr.get(i).getNombreClienteString();
            ob[3] = ListarPr.get(i).getNitClienteString();
            ob[4] = ListarPr.get(i).getTotal_Traslado();
            ...
            ob[8] = ListarPr.get(i).getEstadoTraslado();
    ...
    private void initComponents() {
        ...
        setBorder(null);
        setTitle("ADMINISTRACIÓN DE TRASLADOS");
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(CajaNumero, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        ...
        Estado.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "VIGENTE", "REALIZADO", "ANULADO", "TODOS" }));
        ...
        if (Tabla.getColumnModel().getColumnCount() > 0) {
            ...
            Tabla.getColumnModel().getColumn(9).setPreferredWidth(15);
        }
    ...
    private void TablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaMouseClicked
        ...
        if(Fila < Tabla.getRowCount() && Fila >= 0 && Columna < Tabla.getColumnCount() && Columna >= 0){
            ...
            if(value instanceof JButton){
                ...
                DetalleTrasladosForm de= new DetalleTrasladosForm(codigo, 1, 0, pos, this);
                de.setVisible(true);
            }
        }
    ...
    private void BtnBuscarDocumentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBuscarDocumentoActionPerformed
        ...
        this.Parametro1 = CajaNumero.getText();
        ActualizarTablaEstado(FiltroBusqueda, this.Parametro1, this.Parametro2);
