 ...
 * @author Masaldoter
 */
public class DetallesCotizacion2 extends javax.swing.JInternalFrame {

    conexion cn= conexion.getInstancia();
    ConexionesSQL SQL = new ConexionesSQL();
    Ventas v= new Ventas();
    ...
    public void VerDetalles(){
        ...
        SQL.rs = null;
        SQL.ps = null;
        SQL.cn= SQL.Unionsis2.getConnection();
        try {
            
            SQL.ps = SQL.cn.prepareStatement("select CodigoBarras, NombreProducto, CantidadProductos, PrecioUnitario, Total, Ubicacion, ProductoRegistrado from detalle_cotizacion where NoCotizacion=?");
            SQL.ps.setString(1, NoF);
            
            SQL.rs = SQL.ps.executeQuery();
            ...
            ResultSetMetaData rsMD = SQL.rs.getMetaData();
            int cantidadColumnas = rsMD.getColumnCount();

            int anchotabla[] = {20,150, 10, 10, 10, 6, 2};
    ...
    public void VerDetalles2(){
        ...
        SQL.cn= SQL.Unionsis2.getConnection();
        try {
            SQL.ps = SQL.cn.prepareStatement("select NombreCliente, NitCliente from cotizacion where NoCotizacion=?");
            SQL.ps.setString(1, NoF);
            
            SQL.rs = SQL.ps.executeQuery();
            
            while (SQL.rs.next()) {
            CajaCliente.setText(SQL.rs.getString("NombreCliente"));
            CajaNit.setText(SQL.rs.getString("NitCliente"));
            }
        } catch (SQLException e) {
    ...
    public void VerDetalles3(){
        ...
        SQL.cn= SQL.Unionsis2.getConnection();
        try {
            SQL.ps = SQL.cn.prepareStatement("select idCotizacion, TotalCotizacion, IdUsuario, HoraRealizada, FechaRealizada, Observacion, TotalLetras"
            ...
            if (SQL.rs.next()) {
                Id.setText(SQL.rs.getString("idCotizacion"));
                CajaTotal.setText(SQL.rs.getString("TotalCotizacion"));
            CajaVendedor.setText(SQL.rs.getString("IdUsuario"));
            HoraVenta.setText(SQL.rs.getString("HoraRealizada"));
            Fechaventa.setText(SQL.rs.getString("FechaRealizada"));
            CajaObservacion.setText(SQL.rs.getString("Observacion"));
            TotalLetras.setText(SQL.rs.getString("TotalLetras"));
            TipoDocumento.setText("COTIZACIÓN");
            EstadoVenta.setText(SQL.rs.getString("EstadoCotizacion"));
            }
        } catch (SQLException e) {
    ...
    public void ObtenerId(int Seleccion, int TipoDeVista){
        ...
        try {
            SQL.ps = SQL.cn.prepareStatement(Query);
            
            SQL.rs = SQL.ps.executeQuery();
            
            if (SQL.rs.next()) {
                Id.setText(SQL.rs.getString("idCotizacion"));
                Fac.setText(SQL.rs.getString("NoCotizacion"));
            }
        } catch (SQLException e) {
            System.err.println("Error en JFRAME Detalles2, " + e);
        }finally{
    ...
    private void initComponents() {
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Id)
                    .addComponent(Fechaventa, javax.swing.GroupLayout.DEFAULT_SIZE, 270, Short.MAX_VALUE)
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(TotalLetras, javax.swing.GroupLayout.DEFAULT_SIZE, 710, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addComponent(C, javax.swing.GroupLayout.DEFAULT_SIZE, 730, Short.MAX_VALUE)
        );
        ...
        TablaDetalles.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre", "Cantidad", "Precio", "Total", "Ubicación", "ID"
            }
        ) {
    ...
    public void RealizarVenta(){
        Principal prin= new Principal();
        /**prin.tablamadre.setSelectedIndex(1);
